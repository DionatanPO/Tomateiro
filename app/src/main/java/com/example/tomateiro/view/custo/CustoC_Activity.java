    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_concluir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                custoC.setArame20Q(editA_q11.getText().toString());
                custoC.setFungicidasQ(editA_q12.getText().toString());
                custoC.setHerbicidasQ(editA_q13.getText().toString());
                custoC.setInseticidasQ(editA_q14.getText().toString());
                custoC.setOutrosProdutosQuimicosQ(editA_q15.getText().toString());
                custoC.setOutrosQ(editA_q16.getText().toString());

                custoC.setCalcarioDolomiticoV(editA_q1.getText().toString());
                custoC.setSulfatoAmonioV(editA_q2.getText().toString());
                custoC.setSuperfosfatoSimplesV(editA_q3.getText().toString());
                custoC.setCloretoPotassioV(editA_q4.getText().toString());
                custoC.setEstercoBovinoV(editA_q5.getText().toString());
                custoC.setYorinV(editA_q6.getText().toString());
                custoC.setSementesV(editA_q7.getText().toString());
                custoC.setConfeccaoMudasV(editA_q8.getText().toString());
                custoC.setEstacasBambuV(editA_q9.getText().toString());
                custoC.setArame16V(editA_q10.getText().toString());
                custoC.setArame20V(editA_q11.getText().toString());
                custoC.setFungicidasV(editA_q12.getText().toString());
                custoC.setHerbicidasV(editA_q13.getText().toString());
                custoC.setInseticidasV(editA_q14.getText().toString());
                custoC.setOutrosProdutosQuimicosV(editA_q15.getText().toString());
                custoC.setOutrosV(editA_q16.getText().toString());

                custo_subtotal.setText(custo_subtotal.getText().toString() + custoC.calcularSubTotal(custoC).getSubTotalB());
